...
const HowItWorks = () => {
  return (
    <section id='how-it-works' className="py-10 my-10 bg-gradient-to-r from-blue-50 to-blue-100">
      <div className="container mx-auto px-6">
        <h2 className="text-4xl font-semibold text-center mb-8 text-gray-800">How It Works</h2>
        
        <div className="mx-4 md:mx-22 lg:mx-52 grid grid-cols-1 md:grid-cols-3 gap-8">
