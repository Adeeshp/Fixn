      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-md transition-transform duration-300 hover:scale-105">
            <FaUserCheck className="text-4xl text-primary mb-4 transform transition-transform duration-300 hover:scale-125" />
          ...
          <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-md transition-transform duration-300 hover:scale-105">
            <FaCalendarAlt className="text-4xl text-primary mb-4 transform transition-transform duration-300 hover:scale-125" />
          ...
          <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-md transition-transform duration-300 hover:scale-105">
            <FaCommentsDollar className="text-4xl text-primary mb-4 transform transition-transform duration-300 hover:scale-125" />
